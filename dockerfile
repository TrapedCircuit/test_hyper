...
RUN groupadd --gid $USER_GID $USERNAME \
    ...
    && apt-get update -y && apt-get install -y curl gnupg vim \
...
# Configure gossip peers
RUN echo '{"root_node_ips":[{"Ip":"54.248.41.39"},{"Ip":"13.230.78.76"},{"Ip":"46.105.222.166"},{"Ip":"91.134.41.52"},{"Ip":"52.68.71.160"},{"Ip":"13.114.116.44"}],"try_new_peers":true,"chain":"Mainnet"}' > /home/$USERNAME/override_gossip_config.json
